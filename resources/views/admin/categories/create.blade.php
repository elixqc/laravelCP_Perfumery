...
@section('title', 'Add Category — Prestige Admin')
...
<div class="pa-page">
    ...
    <div class="pa-page-header">
        <div>
            ...
            <h1 class="pa-page-title">Add Category</h1>
        </div>
    ...
    <div style="max-width:700px; margin:0 auto; width:100%;">
        <form method="POST" action="{{ route('admin.categories.store') }}" id="create-category-form" novalidate>
            @csrf
