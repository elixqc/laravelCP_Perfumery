...
@section('title', 'Add Supplier — Prestige Admin')
...
<div class="pa-page">
    ...
    <div style="max-width:700px; margin:0 auto; width:100%;">
        <form method="POST" action="{{ route('admin.suppliers.store') }}" id="create-supplier-form" novalidate>
            @csrf
                ...
                <div style="background:#FDFBF8; border:1px solid #D6D0C8; padding:2rem; display:flex; flex-direction:column; gap:1.5rem;">
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.4rem;">
                        ...
                        <textarea name="address" id="address" rows="4"
                                  ...
                                  onfocus="this.style.borderColor='#B5975A'"
                                  onblur="this.style.borderColor='{{ $errors->has('address') ? '#C97A7A' : '#B0A898' }}'">{{ old('address') }}</textarea>
...
<script>
    ...
    document.getElementById('create-supplier-form').addEventListener('submit', function(e) {
        let hasError = false;
