...
<div class="pa-overlay" id="pa-delete-overlay" aria-modal="true" role="dialog">
    <div class="pa-modal" id="pa-delete-modal">
        <div class="pa-modal__head">
            ...
            <h2 class="pa-modal__title">Archive this supplier?</h2>
        </div>
        <div class="pa-modal__body">
            <span class="pa-modal__product-name" id="pa-modal-supplier-name">—</span>
            <p class="pa-modal__text">
                This supplier will be archived and hidden from active records.
                It can be restored at any time.
            </p>
        </div>
        <div class="pa-modal__foot">
            <button class="pa-modal__cancel" id="pa-modal-cancel">Cancel</button>
            <button class="pa-modal__confirm" id="pa-modal-confirm">Archive supplier</button>
        </div>
    </div>
</div>
...
<div class="pa-page">
    ...
    <div class="pa-page-header">
        ...
        <div class="pa-page-actions">
            <a href="{{ route('admin.suppliers.create') }}" class="pa-btn-primary">
                + Add Supplier
            </a>
        </div>
    </div>
    ...
    <div class="pa-section">
        ...
        <div class="pa-stats-ribbon">
            <div class="pa-stat-tile">
                <span class="pa-stat-tile__label">Total Suppliers</span>
        ...
        <div class="pa-table-shell">
            <table id="suppliers-table" class="pa-products-table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Company Name</th>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const table = $('#suppliers-table').DataTable({
            ...
            ajax: {
                ...
                error: (xhr, error, thrown) => {
                    ...
                    showToast({ icon: '✕', iconClass: 'pa-toast__icon--error', title: 'Failed to load suppliers', sub: 'Please refresh the page.' });
                },
            },
            columns: [
                {
            ...
            language: {
                ...
                lengthMenu: 'Display _MENU_ suppliers',
        ...
        const nameEl     = document.getElementById('pa-modal-supplier-name');
        ...
        function attachDeleteListeners() {
            document.querySelectorAll('.pa-supplier-delete').forEach(btn => {
        ...
        function onDeleteClick(e) {
            e.preventDefault();
            pendingDeleteId   = this.dataset.supplierId;
            pendingDeleteName = this.dataset.supplierName || 'this supplier';
        ...
        confirmBtn.addEventListener('click', () => {
            ...
            .then(() => {
                ...
                showToast({
                    ...
                    sub: 'Supplier soft-deleted successfully',
                });
            })
            .catch((err) => {
                closeModal();
            ...
            .finally(() => {
                ...
                confirmBtn.textContent = 'Archive supplier';
            });
        });
