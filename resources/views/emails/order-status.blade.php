            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%;">
                ...
                <tr>
                    <td align="center" style="background-color:#1A1714; padding:36px 40px 28px;">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
                            <tr><td style="height:1px; background:#B5975A; opacity:0.4;"></td></tr>
                        </table>
                ...
                <tr>
                    <td style="background-color:#FDFBF8; padding:36px 40px; border:1px solid #EDE8DF; border-top:none;">
                        ...
                        {{-- Order Items — price from product.selling_price --}}
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F8F5F0; padding:20px; margin-bottom:28px;">
                            ...
                            <tr>
                                ...
                                <td align="right" style="font-size:13px; color:#5A524A; font-weight:300; padding-top:10px;">{{ $order->user->address }}</td>
                            </tr>
                            <tr>
                                ...
                                <td align="right" style="font-size:13px; color:#5A524A; font-weight:300; padding-top:10px; text-transform:capitalize;">{{ strtoupper($order->payment_method) }}</td>
                            </tr>
                            @if($order->payment_reference)
                            <tr>
                                <td style="font-size:9px; letter-spacing:2px; text-transform:uppercase; color:#C8BEB2; font-weight:300; padding-top:10px;">Reference No.</td>
                                <td align="right" style="font-size:13px; color:#5A524A; font-weight:300; padding-top:10px; font-family:'Courier New',monospace;">{{ $order->payment_reference }}</td>
                            </tr>
                            @endif
                        </table>
